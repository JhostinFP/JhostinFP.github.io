...
document.getElementById("add-task").addEventListener("click", () => {
  ...
  // Volver a asignar el evento 'change' a la nueva entrada de tiempo
  newTask.querySelector(".time-start").addEventListener("change", updateTimes);
  newTask.querySelector(".time-end").addEventListener("change", updateTimes);
});
